...
set -g status-right "#[fg=colour15]#{=-50:pane_title} #[fg=#222222,bg=colour208,bold]#{?client_prefix, C ,}#{?window_zoomed_flag, Z ,}#{?session_many_attached, M ,}#{?window_bell_flag, B ,}#[bg=default] #[fg=#ffffff,bg=colour197,bold] %m/%e %I:%M "
